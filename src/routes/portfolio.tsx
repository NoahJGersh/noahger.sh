  ...
  return (
    <div>
      ...
      <div className="flex flex-col p-4 pt-2">
        ...
        >
          An arcade-style game where you dig up grapple points and try to hold
          on while a storm blows you around. I co-designed the gameplay, and
          fully implemented it in Godot, using GDScript. Made for Brackey&apos;s
          Game Jam 2024.
        </Project>
      </div>
    </div>
